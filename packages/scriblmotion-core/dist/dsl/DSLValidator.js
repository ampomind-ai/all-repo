...
// ─────────────────────────────────────────────────────────────────────────────
import { SUPPORTED_VERSION, VALID_LAYER_TYPES, VALID_ENTITY_TYPES, VALID_EASING_NAMES, VALID_COORDINATE_SYSTEMS, } from './Schema';
import { isValidId, isValidHex, MAX_NESTING_DEPTH, MAX_SCENE_DURATION_MS, MAX_ENTITIES, MAX_ANIMATIONS_PER_SCENE, MAX_CHARACTERS, } from '../utils/Guards';
export class DSLValidator {
    ...
    // ── Private ────────────────────────────────────────────────────────────────
    validateEntities(entities, parentPath, errors, entityIds, counters, depth = 1) {
    ...
    validateAnimation(anim, path, errors) {
...
//# sourceMappingURL=DSLValidator.js.map
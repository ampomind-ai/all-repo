            ...
            <div className="max-w-5xl mx-auto py-10 px-8">
                ...
                <div className="flex items-center gap-2 border rounded-xl px-4 py-3 mb-8" style={{ background: "var(--surface-2)", borderColor: "var(--surface-border)" }}>
                    ...
                    <Input
                        ...
                        className="flex-1 bg-transparent border-none text-[14px] text-zinc-100 placeholder:text-zinc-600 focus-visible:ring-0 px-0 h-auto shadow-none"
                    />
                </div>
                ...
                <div className="mb-10">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                        {FOLDERS.map(folder => (
                            <Button variant="outline" key={folder.name} className="flex h-auto justify-start items-center gap-3 p-3 rounded-xl border transition-all hover:bg-zinc-800/40 text-left" style={{ background: "var(--surface-2)", borderColor: "var(--surface-border)" }}>

...
import { Button, Input, Dialog, DialogTrigger, DialogContent, DialogHeader, DialogTitle, DialogDescription, DialogFooter, DialogClose, Label } from "ui";
            ...
            <div className="max-w-5xl mx-auto py-10 px-8">
                    ...
                    <Dialog>
                        ...
                        <DialogContent className="sm:max-w-[425px]">
                            <DialogHeader>
                                ...
                                <DialogDescription>
                                    Paste a course URL to start importing notes and tracking progress.
                                </DialogDescription>
                            </DialogHeader>
                            <div className="grid gap-5 py-4">
                                <div className="grid gap-2">
                                    <Label htmlFor="courseUrl" className="text-zinc-400">
                                        URL
                                    </Label>
                                    <Input
                                        id="courseUrl"
                                ...
                                <div className="grid gap-2">
                                    <Label htmlFor="courseTitle" className="text-zinc-400">
                ...
                <div className="space-y-3">
                    {filtered.map(course => {
                        ...
                        return (
                            <Link href={`/courses/${course.id}`} key={course.id} className="block group rounded-xl border p-5 transition-all cursor-pointer hover:border-zinc-700/40" style={{ background: "var(--surface-2)", borderColor: "var(--surface-border)" }}>
                                ...
                                <div className="flex items-center justify-between mt-auto pt-4 border-t border-zinc-800/50 relative z-10">
                                    <Button variant="ghost" size="sm" className="h-7 px-3 text-[11px] font-medium text-zinc-500 hover:text-zinc-200 hover:bg-zinc-800/20 transition-colors" onClick={(e) => e.preventDefault()}><Sparkles size={12} className="mr-1.5" /> AI Notes</Button>
                                    <Button variant="ghost" size="sm" className="h-7 px-3 text-[11px] font-medium text-zinc-500 hover:text-zinc-200 hover:bg-zinc-800/20 transition-colors" onClick={(e) => e.preventDefault()}><ExternalLink size={12} className="mr-1.5" /> Open</Button>
                                </div>
                            </Link>
                        );
                    })}

...
import { Button, Dialog, DialogContent, DialogDescription, DialogHeader, DialogTitle, DialogTrigger, DialogFooter, DialogClose, Input, Label, Textarea } from "ui";
            ...
            <div className="max-w-4xl mx-auto py-10 px-8">
                    ...
                    <Dialog>
                        ...
                        <DialogContent className="sm:max-w-[425px]">
                            <DialogHeader>
                                ...
                                <DialogDescription>
                                    Select a topic to start comparing multiple research sources.
                                </DialogDescription>
                            </DialogHeader>
                            <div className="grid gap-5 py-4">
                                <div className="grid gap-2">
                                    <Label htmlFor="topic" className="text-zinc-400">
                                        Topic
                                    </Label>
                                    <Input
                                        id="topic"
                                ...
                                <div className="grid gap-2">
                                    <Label htmlFor="description" className="text-zinc-400">
                                        Goals <span className="text-zinc-600 font-normal ml-1">(Optional)</span>
                                    </Label>
                                    <Textarea
                                        id="description"
                                        placeholder="What specific angles are you comparing?"
                ...
                <div className="space-y-4">
                    {COMPARISONS.map(comp => (
                        <Link href={`/comparisons/${comp.id}`} key={comp.id} className="block rounded-xl border p-5 transition-all cursor-pointer hover:border-zinc-700/40" style={{ background: "var(--surface-2)", borderColor: "var(--surface-border)" }}>
